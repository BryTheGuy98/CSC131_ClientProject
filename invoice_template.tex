...
%----------------------------------------
\newcommand{\clientitem}[4]{
 
 \vspace{0.02\textheight}

 \begin{tabular}{ | m{4.1cm} | m{4.1cm}| m{4.1cm} | m{4.1cm} | }
    \hline
    \bf Client ID: & \bf Client Name: & \bf Client PO: & \bf Payment Terms:\\
    \hline
    {#1} & {#2} & {#3} & {#4}\\
    \hline
 \end{tabular}
...
\newenvironment{invoicetable}{
 ...
 \begin{longtable}[H]{@{} L{0.45\textwidth}R{0.15\textwidth} R{0.15\textwidth} R{0.15\textwidth} @{\hspace{16pt}} |L{0.15\textwidth} @{}} \cline{1-4} % Define invoice table column widths and alignments (L, R or C for left, right or center alignment)
  \vline \hspace{1mm} \textbf{DESCRIPTION} & \textbf{QUANTITY} & \textbf{UNIT PRICE} & \textbf{SUBTOTAL} & \\ \cline{1-4} % Header row
}{
\cline{1-4}
...
% LaTeX Template
% Version 1.0 (September 30th, 2023)
%
...
\begin{minipage}[t]{0.5\textwidth}
	...
	\textbf{Date due:} \duedatedays{30} % Use the \duedatedays{<number>} command to automatically determine the date when the invoice is due using the number of days from today in the single parameter to the command, or remove it and enter a due date manually
...
\begin{minipage}[t]{0.35\textwidth}
	...
	5090 Robert J Mathews Pkwy\\ % Payee contact lines
...
\clientitem{383949393893}{Evil Inc.}{11-8902}{Next 30 Days}


\begin{invoicetable}
	\invoiceitem{PCBA BBV-BC-105 Rev 1}{1}{419.57}{}
	\invoiceitem{Flange Shaft Coupling Connector}{1}{9.31}{}
	\invoiceitem{Linear bearing set of 12}{1}{13.97}{}
	\invoiceitem{5pc 304 stainless steel rod}{1}{17.66}{}
	\invoiceitem{Metal Mart}{1}{233.57}{}
	\invoiceitem{McMaster}{1}{325.14}{}
	\invoiceitem{Horace, Software Engineer 7/31 to 8/27/23 hours}{12.50}{150}{}
	\invoiceitem{Jasper, Firmware Engineer 7/31 to 8/27/23 hours}{35.50}{150}{}
	\invoiceitem{Flotsam, Electrical Engineer 7/31 to 8/27/23 hours}{7.50}{150}{}
	\invoiceitem{Iago, Mechanical Engineer 7/31 to 8/27/23 hours}{34.10}{150}{}
	\invoiceitem{Smee, Mechanical Intern 7/31 to 8/27/23 hours}{3.50}{85.00}{}
\end{invoicetable}
...
\invoiceconditions{Terms and Conditions: Blah blah blah Blah blah blah Blah blah blah Blah blah blah Blah blah blah Blah blah blah Blah blah blah Blah blah blah Blah blah blah Blah blah blah Blah blah blah Blah blah blah}% Leave command empty (i.e. \invoiceconditions{}) if not required
...
\begin{minipage}[t]{0.3\textwidth}
	...
	\href{https://ansync.com}{ansync.com} \\ % Merchant contact information lines
